...
class BSTItr {
public:
	//virtual void reset(const BST<Comparable> &bt) = 0;
	virtual void advance() = 0;
	virtual Comparable &retrieve() = 0;
	virtual bool isAtEnd() = 0;
};

template <class Comparable>
class BSTItrPost: public BSTItr<Comparable> {
public:
	BSTItrPost(const BST<Comparable> &bt);
	//void reset(const BST<Comparable> &bt) { *this = BSTItrPost(const BST<Comparable> &bt); };
	void advance();
...
template <class Comparable>
class BSTItrPre: public BSTItr<Comparable> {
public:
	BSTItrPre(const BST<Comparable> &bt);
	//void reset(const BST<Comparable> &bt) { *this = BSTItrPre(const BST<Comparable> &bt); };
	void advance();
	Comparable &retrieve() { return itrStack.top()->element; }
	bool isAtEnd() { return itrStack.empty(); }
...
template <class Comparable>
class BSTItrIn : public BSTItr<Comparable>{
public:
	BSTItrIn(const BST<Comparable> &bt);
	//void reset(const BST<Comparable> &bt) { *this = BSTItrIn(const BST<Comparable> &bt); };
	void advance();
	Comparable &retrieve() { return itrStack.top()->element; }
	bool isAtEnd() { return itrStack.empty(); }
...
template <class Comparable>
class BSTItrLevel : public BSTItr<Comparable> {
public:
	BSTItrLevel(const BST<Comparable> &bt);
	//void reset(const BST<Comparable> &bt) { *this = BSTItrLevel(const BST<Comparable> &bt); };
	void advance();
